...
def loadLevel():
    ...
    #levelFile = open('Documents/workspace/Finder/levels/1')
...
def main():
    ...
    pygame.display.set_caption("Finder") # Пишем в шапку
    ...
    end_img = Image.open('blocks/nichosi.jpg')
    end_img.show()
    time.wait(2000)
